...
//        asks for input until appropriate input is given
    ...
    /**
     * Displays results calculated in main method.
     *
     * @param out
     * @param w
     * @param x
     ...
     * @param errPts
     */
    private static void dispResults(double w, double x, double y, double z,
            double[] errPts, SimpleWriter out) {
        int index = 0;
        ...
        out.println("Respective exponent (d): " + errPts[index]);
    }
...
//        calculate w, x, y, z, and a, b, c, d
        for (a = 0; a < dejagerExponents.length; a++) {
            for (b = 0; b < dejagerExponents.length; b++) {
                for (c = 0; c < dejagerExponents.length; c++) {
                    for (d = 0; d < dejagerExponents.length; d++) {
...
//        display results
        ...
        dispResults(w, x, y, z, errPts, out);
